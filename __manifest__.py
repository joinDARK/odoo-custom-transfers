{
    ...
    "data": [
        ...
        "views/contragent_contract_views.xml",
        ...
        "views/amanat_dashboard_views.xml",
        ...
        "views/swift_document_upload_views.xml",
        "views/signature_library_views.xml",
        "views/template_library_views.xml",
        "views/zayavka_signature_views.xml",
        "views/jess_rate_views.xml",
        # Calculator views
    ...
    "assets": {
        ...
        "web.assets_backend": [
            ...
            "amanat/static/src/js/pin_field_handler.js",
            "amanat/static/src/js/pin_field_integration.js",
